...
// Videos are generated in frontend/output by the Python script
const outputDir = path.resolve(__dirname, '../../../frontend/output');
console.log('[Server] Serving videos from:', outputDir);
